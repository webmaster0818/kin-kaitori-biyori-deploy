(function() {
  ...
  box.innerHTML = '<div style="font-size:11px;color:#8a7a55;margin-bottom:4px;">本日の金買取相場の目安（2026-08-07・田中貴金属公表値より純度換算）</div>'
    + '<div style="font-size:22px;font-weight:700;color:#9a7b2d;">K24 22,646円<span style="font-size:12px;font-weight:400;">/g</span></div>'
    + '<div style="font-size:13px;margin-top:2px;">K18 16,985円/g ・ K14 13,210円/g</div>'
